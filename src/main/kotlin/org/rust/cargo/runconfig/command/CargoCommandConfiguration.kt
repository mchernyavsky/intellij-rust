...
class CargoCommandConfiguration(
    ...
    override fun writeExternal(element: Element) {
        ...
        element.writeString("sdk", sdk?.name)
    ...
    override fun readExternal(element: Element) {
        ...
        element.readString("sdk")?.let { sdk = findSdkByKey(it) }
    ...
    fun clean(): CleanConfiguration {
        ...
        return when {
            ...
            !toolchain.looksLikeValidToolchain() -> CleanConfiguration.error("Invalid toolchain: ${toolchain.location}")
