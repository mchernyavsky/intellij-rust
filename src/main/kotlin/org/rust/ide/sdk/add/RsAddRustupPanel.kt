...
//    private val existingSdks: List<Sdk>
    ...
    private val rustupPathField: TextFieldWithBrowseButton =
        TextFieldWithBrowseButton().apply {
            val path = RustupService.getInstance().PREFERRED_RUSTUP_PATH ?: RustupService.getSystemCondaExecutable()
            path.let { text = it }
    ...
    private val toolchainsField: JComboBox<String> =
        ComboBox(supportedLanguageLevels.toTypedArray()).apply {
    ...
    private val projectBasePath: @SystemIndependent String?
        get() = newProjectPath ?: module.basePath
