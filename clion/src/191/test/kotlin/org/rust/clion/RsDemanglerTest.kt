...
import org.rust.clion.RsDemangler.demangle

class RsDemanglerTest : TestCase() {
    fun `test demangle`() {
        checkError("test")
    ...
    fun `test demangle without hash`() {
        ...
        check(symbol, "foo::h05af221e174051e9", skipHash = true)
    }
